#' ##------------------------------------------------------------------------------
#' #' @title tidymicrobiome_install
#' #' @description Install all packages in tidymicrobiome.
#' #' @author Xiaotao Shen
...
#'       devtools::install_github(
#'         repo = "tidymicrobiome/massdataset",
#'         force = force,
#'         upgrade = upgrade,
#'         dependencies = TRUE,
#'         ...
...
#'       devtools::install_github(
#'         repo = "tidymicrobiome/massprocesser",
#'         force = force,
#'         upgrade = upgrade,
#'         dependencies = TRUE,
#'         ...
...
#'       devtools::install_github(
#'         repo = "tidymicrobiome/masscleaner",
#'         force = force,
#'         upgrade = upgrade,
#'         dependencies = TRUE,
#'         ...
